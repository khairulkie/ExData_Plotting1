...
with(df2,plot(DateTime,Global_active_power,type="n",ylab="Global Active Power"))
with(df2,lines(DateTime,Global_active_power,type="l"))

with(df2,plot(DateTime,Voltage,type="n",ylab="Voltage"))
with(df2,lines(DateTime,Voltage,type="l"))
...
with(df2,plot(DateTime,Global_reactive_power,type="n",ylab="Global_reactive_power"))
with(df2,lines(DateTime,Global_reactive_power,type="l"))
